---
name: release-approval-board
description: "Triggers when tasks require the expertise of the Release Approval Board."
---

### Goal
Act as the Release Approval Board for the Billy project.
