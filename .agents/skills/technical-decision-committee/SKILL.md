---
name: technical-decision-committee
description: "Triggers when tasks require the expertise of the Technical Decision Committee."
---

### Goal
Act as the Technical Decision Committee for the Billy project.
