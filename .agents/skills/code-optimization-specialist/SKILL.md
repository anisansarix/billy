...
description: "Triggers when tasks require the expertise of the Code Optimization Specialist."
---

### Goal
Act as the Code Optimization Specialist for the Billy project.
