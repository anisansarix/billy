...
export const DEFAULT_BUSINESS: Business = ${JSON.stringify(DEFAULT_BUSINESS, null, 4)} as any;

export const PARTIES: Party[] = ${JSON.stringify(parties, null, 4)} as any;

export const ITEMS: InventoryItem[] = ${JSON.stringify(items, null, 4)} as any;

export const INVOICES: SalesInvoice[] = ${JSON.stringify(invoices, null, 4)} as any;

export const PURCHASES: PurchaseOrder[] = ${JSON.stringify(purchases, null, 4)} as any;
