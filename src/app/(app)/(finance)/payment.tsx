        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
            ...
            <View className="flex-row items-center p-4 bg-white shadow-sm z-10 border-b border-border">
                ...
                <View className="ml-2 flex-1">
                    <Text className="text-lg font-sans-bold text-primary">Payments</Text>
                    <Text className="text-xs font-sans-medium text-muted-foreground">Manage your payment records</Text>
                </View>
            </View>
